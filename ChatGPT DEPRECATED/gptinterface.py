...
class ChatGPT:
    ...
    def get_messages(self):
        ...
        messages = self.driver.find_elements(
            By.XPATH, """//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div"""
        )

        text_messages = []
        for message in range(1, len(messages)):
            try:
                xpath = rf"""//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[{message}]/div/div[2]/div[1]/div/div"""
                text = self.driver.find_element(By.XPATH, xpath).text
                complete = True
                if message == len(messages) and self.is_generating():
                    complete = False
                text_messages.append(
                    {"author": "OpenAI", "text": text, "complete": True}
                )
            except selenium.common.exceptions.NoSuchElementException as e:
                xpath = rf"""//*[@id="__next"]/div[1]/div[1]/main/div[1]/div/div/div/div[{message}]/div/div[2]/div[1]/div"""
                text = self.driver.find_element(By.XPATH, xpath).get_attribute(
                    "innerHTML"
                )
                text_messages.append({"author": "user", "text": text, "complete": True})
    ...
    def regenerate_response(self):
        ...
        """
        button = (
            r"""/html/body/div[1]/div[2]/div[1]/main/div[2]/form/div/div[1]/button"""
        )
    ...
    def is_generating(self):
        ...
        """
        button = (
            r"""//*[@id="__next"]/div[1]/div[1]/main/div[2]/form/div/div[2]/button"""
        )
    ...
    def delete_element(self, jsReference):
        ...
        self.driver.execute_script(
            rf"""elem = document.querySelector("{jsReference}"); elem.remove();"""
        )
    ...
    def regenerate_response_error(self):
        ...
        if self.does_element_exist(
                By.XPATH,
                """//*[@id="__next"]/div[2]/div[1]/main/div[2]/form/div/div/span""",
        ):
    ...
    def load_page(self, token, conversation_id):
        ...
        login_button = self.does_element_exist(
        ...
        sleep(1)
        # headless login check
        if self.does_element_exist(
                By.XPATH, """//*[@id="headlessui-dialog-panel-:r3:"]/div[2]/button"""
        ):
        ...
        self.input_field = self.driver.find_element(
            By.XPATH,
            """//*[@id="__next"]/div[2]/div[1]/main/div[2]/form/div/div[2]/textarea""",
        )

        check_style = self.driver.find_element(By.XPATH, """//*[@id="__next"]/div[1]""")
        if (
                check_style.get_attribute("style")
                == "position: fixed; top: 1px; left: 1px; width: 1px; height: 0px; padding: 0px; margin: -1px; overflow: hidden; clip: rect(0px, 0px, 0px, 0px); white-space: nowrap; border-width: 0px; display: none;"
        ):
    ...
    def get_error(self):
        ...
        """
        error_message = (
            r"""//*[@id="__next"]/div[1]/div[1]/main/div[2]/form/div/div/span"""
        )
